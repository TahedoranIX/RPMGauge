...
# coche = Smart(rs=0, en=5, d4=26, d5=19, d6=13, d7=6, e1=20, e2=16, eb=21, port=port, minimumSpeed=MINIMUM_SPEED, debug=False, debugOBD=False) # Configuración para otra raspberry.
while True:
    try:
